...
RUN apt-get update && apt-get install -y --no-install-recommends libreoffice-calc-nogui git ca-certificates \
...
ENV PORT=8080 DB_PATH=/srv/data/app.db PYTHONUNBUFFERED=1
EXPOSE 8080
